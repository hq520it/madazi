package com.madazi.framework.aspectj;
...
import com.madazi.common.core.domain.BaseEntity;
...
import com.madazi.framework.security.context.PermissionContextHolder;
...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String userAlias, String deptAlias, String userField, String deptField, String permission)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.{} IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} or {}::text = ANY(string_to_array(ancestors, ',')) )", deptAlias, deptField, user.getDeptId(), user.getDeptId()));
            }
