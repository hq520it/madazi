...
import { IconDatabase, IconDevtools, IconFiles, IconGit, IconPanelOff, IconSettings, IconUsage } from './icons.tsx'
  ...
  return (
    <aside className={css.root} data-git-ide-panel="side">
      ...
      <div className={css.tabs} role="tablist">
        ...
        <IconButton label={t('ide.db')} active={tab === 'db'} onClick={() => { onTab('db') }}>
          <IconDatabase />
        </IconButton>
        {showUsageTab ? (
      ...
      <div className={css.body}>
        {tab === 'git' ? (
          ...
          <DatabasePanel workspacePath={workspacePath} />
