...
export function IconDatabase() {
  return (
    <Icon>
      <ellipse cx="8" cy="3.8" rx="5.2" ry="2.1" fill="none" stroke="currentColor" strokeWidth="1.2" />
      <path d="M2.8 3.8v8.4c0 1.16 2.33 2.1 5.2 2.1s5.2-.94 5.2-2.1V3.8" fill="none" stroke="currentColor" strokeWidth="1.2" />
      <path d="M2.8 8c0 1.16 2.33 2.1 5.2 2.1s5.2-.94 5.2-2.1" fill="none" stroke="currentColor" strokeWidth="1.2" />
    </Icon>
  )
}
