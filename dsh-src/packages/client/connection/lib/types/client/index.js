...
export function apply(ctx) {
    ...
    const handle = {
        isLoopback: transport?.ownsHost === true || pageLocation === undefined || isLoopbackHostname(pageLocation.hostname) || globalThis.__DSH_TRUSTED_LOOPBACK__ === true, // madazi loopback fence relax (patch 01)
        generation: {
