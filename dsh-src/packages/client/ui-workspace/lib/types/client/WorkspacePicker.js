...
import { gatedWorkspaces, getMembershipVersion, startMembershipWatch, subscribeMembership, } from "./membership-gate.js";
...
export function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, useDirectoryFlow, renderDirectoryFlow, onPick, onClose, addOnly = false, side = 'bottom', selectedId, }) {
    ...
    const workspaces = useMemo(() => gatedWorkspaces(workspaceSnapshot.items), [workspaceSnapshot.items, gateVersion]);
