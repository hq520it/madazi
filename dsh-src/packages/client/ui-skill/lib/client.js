window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:./dsh-src/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = "._8BAfzG_card{flex-direction:column;display:flex}._8BAfzG_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}._8BAfzG_row[data-expandable]{cursor:pointer}._8BAfzG_card[data-state=running] ._8BAfzG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _8BAfzG_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes _8BAfzG_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}._8BAfzG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}._8BAfzG_chevron{color:var(--dsw-alias-label-secondary)}._8BAfzG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}._8BAfzG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}._8BAfzG_row:hover ._8BAfzG_iconIdle{opacity:0}._8BAfzG_row:hover ._8BAfzG_chevronHover{opacity:1}._8BAfzG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}._8BAfzG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._8BAfzG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._8BAfzG_errorSummary{color:var(--dsw-alias-state-error-primary)}._8BAfzG_bodyWrap{flex-direction:column;display:flex}._8BAfzG_instructionsCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}._8BAfzG_instructionsHeader{border-bottom:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}._8BAfzG_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}._8BAfzG_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}._8BAfzG_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._8BAfzG_instructions::-webkit-scrollbar-track{margin:6px 0}._8BAfzG_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._8BAfzG_card:hover ._8BAfzG_inspectButton,._8BAfzG_inspectButton:focus-visible{opacity:1}._8BAfzG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._8BAfzG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){._8BAfzG_card[data-state=running] ._8BAfzG_row:after{animation:none;display:none}._8BAfzG_iconIdle,._8BAfzG_chevronHover,._8BAfzG_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "_8BAfzG_bodyWrap",
			"card": "_8BAfzG_card",
			"chevron": "_8BAfzG_chevron",
			"chevronHover": "_8BAfzG_chevronHover",
			"dsh-skill-row-sweep": "_8BAfzG_dsh-skill-row-sweep",
			"errorSummary": "_8BAfzG_errorSummary",
			"iconIdle": "_8BAfzG_iconIdle",
			"inspectButton": "_8BAfzG_inspectButton",
			"instructions": "_8BAfzG_instructions",
			"instructionsCard": "_8BAfzG_instructionsCard",
			"instructionsHeader": "_8BAfzG_instructionsHeader",
			"leading": "_8BAfzG_leading",
			"row": "_8BAfzG_row",
			"separator": "_8BAfzG_separator",
			"summary": "_8BAfzG_summary",
			"title": "_8BAfzG_title",
			"visuallyHidden": "_8BAfzG_visuallyHidden"
		};
		//#endregion
